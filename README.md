...
- [Estrategia de Branching](./docs/branching-strategy.md) - Estrategia de branching y flujo de trabajo

## Estrategia de Branching

Este proyecto utiliza **GitHub Flow** como estrategia de branching. Para más detalles sobre convenciones, flujo de trabajo y ejemplos, consulta la [documentación completa de branching](./docs/branching-strategy.md).

**Resumen rápido:**
- Branch principal: `main`
- Convención de nombres: `[tipo]/DNT-XXX-descripcion`
- Siempre usar Pull Requests para cambios
- Merge mediante Squash and Merge
